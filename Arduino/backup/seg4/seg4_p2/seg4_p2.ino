...
void setup() {  
  pinMode(13, INPUT);//water level
  pinMode(4, OUTPUT);//tankvalve
  pinMode(5, OUTPUT);//autolight
...
void loop() {
  ...
  int val;
  String s;    
  if (req.indexOf("/tankvalve/0") != -1){
    digitalWrite(4, 0);
    s = "HTTP/1.1 200 OK\r\nContent-Type: text/plain\r\n\r\nDoor locked!";}
    
  else if (req.indexOf("/tankvalve/1") != -1){
    digitalWrite(4, 1);
    s = "HTTP/1.1 200 OK\r\nContent-Type: text/plain\r\n\r\nDoor unlocked!";}
    
  else if (req.indexOf("/tankvalve/check/1") != -1){    
    if(digitalRead(4)==LOW){
      pos="tank valve is closed!";}
    else if(digitalRead(4)==HIGH){
      pos="tank valve is open!";}
    s = "HTTP/1.1 200 OK\r\nContent-Type: text/plain\r\n\r\n"+pos;}      

  else if (req.indexOf("/rain/0") != -1){
    digitalWrite(14, 0);
    s = "HTTP/1.1 200 OK\r\nContent-Type: text/plain\r\n\r\nLeakage Sensor Down";}
